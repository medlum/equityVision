...
def fetch_stock_data(ticker, period, sma_period, ema_period, bb_period, bb_std, macd_fast, macd_slow, macd_signal, rsi_period, strategy):
...
def markdown_disclaimer():
    ...
    st.markdown(
        f"""
            <p style = 'color: #7d8796; font-size: 10px; text-align: justify;' > {disclaimer_text} </p >
            """,
